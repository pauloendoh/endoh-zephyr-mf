...
class ZephyrEngine {
    ...
    static async create(options) {
        ...
        (0, logging_1.ze_log)('Initialized: loading application configuration...');
    ...
    async resolve_remote_dependencies(deps) {
        ...
        const tasks = deps.map(async (dep) => {
            ...
            if (!zephyr_edge_contract_1.ZeUtils.isSuccessTuple(tuple)) {
                (0, logging_1.ze_log)(`Failed to resolve remote dependency: ${dep.name}@${dep.version}`, 'skipping...');
                return null;
            }
    ...
    async start_new_build() {
        ...
        ze.hash_list
            ...
            (0, logging_1.ze_log)(`Loaded: hash list with ${hash_set.hash_set.size} entries`);
        })
